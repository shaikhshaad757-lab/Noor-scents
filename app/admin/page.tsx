    ...
    <div className="min-h-screen pt-24 px-4 max-w-4xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link href="/admin/products/new"
          className="flex flex-col items-center justify-center gap-2 p-8 bg-primary text-black hover:opacity-80 transition text-center">
        ...
        <Link href="/admin/products"
          className="flex flex-col items-center justify-center gap-2 p-8 border border-border hover:border-primary transition text-center">
          <span className="text-3xl">📦</span>
        ...
        <Link href="/admin/about"
          ...
          <span className="text-xs text-foreground/50">Update brand story & image</span>
        </Link>

        <Link href="/"
          className="flex flex-col items-center justify-center gap-2 p-6 border border-border hover:border-primary transition text-center">
